...
-- Volcando estructura de base de datos para cloudmarket
DROP DATABASE IF EXISTS `cloudmarket`;
CREATE DATABASE IF NOT EXISTS `cloudmarket` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `cloudmarket`;
...
-- Volcando datos para la tabla cloudmarket.usuarios: ~1 rows (aproximadamente)
